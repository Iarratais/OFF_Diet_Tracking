...
import android.karl.dao.FoodDAO;
import android.karl.dao.IFoodDAO;
...
public class ResultPer100Fragment extends android.support.v4.app.Fragment {
    ...
    class BarcodeSearchTask extends AsyncTask<String, Integer, List<Food>> {
        ...
        protected void onPostExecute(List<Food> foods) {
            ...
            final String sat_fats = df.format(Float.parseFloat(foods.get(0).getSat_fats())) + getString(R.string.grams_abbv);
            ...
            BarData chartData = new BarData(getXAxisValues(), getDataSet(foods.get(0).getFats(), foods.get(0).getSat_fats(), foods.get(0).getProtein(),
